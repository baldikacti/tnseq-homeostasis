...
dft = read.table("/Users/tingtingzhao/Documents/Research/TnqData/FinalData/TC_mid_batchcorrected_dclpb_included.tsv",sep = '\t', header = TRUE)
dftNonZero = dft
head(dftNonZero)
...
save(logRatioKnockoffParamWildAdjusted, file="~/Documents/Research/TnqData/FinalData/logRatioKnockoffParamWildWholeAdjusted.Rdata")
#logRatioKnockoffParamWildAdjusted = create_Yknockoff_para(wildMtx, "sdp", shrink=TRUE)
...
save(logRatioKnockoffParamDlonAdjusted, file="~/Documents/Research/TnqData/FinalData/logRatioKnockoffParamDlonWholeAdjusted.Rdata")
...
save(logRatioKnockoffParamDclpaAdjusted, file="~/Documents/Research/TnqData/FinalData/logRatioKnockoffParamDclpaWholeAdjusted.Rdata")
...
save(logRatioKnockoffParamdnakAdjusted, file="~/Documents/Research/TnqData/FinalData/logRatioKnockoffParamdnakWholeAdjusted.Rdata")
...
save(logRatioKnockoffParamdclpbAdjusted, file="~/Documents/Research/TnqData/FinalData/logRatioKnockoffParamdclpbWholeAdjusted.Rdata")
...
load("~/Documents/Research/TnqData/FinalData/logRatioKnockoffParamWildWholeAdjusted4Rep.Rdata")
load("~/Documents/Research/TnqData/FinalData/logRatioKnockoffParamDlonWholeAdjusted4Rep.Rdata")
load("~/Documents/Research/TnqData/FinalData/code/Final/logRatioKnockoffParamDclpaWholeAdjusted4Rep.Rdata")
load("~/Documents/Research/TnqData/FinalData/logRatioKnockoffParamdnakWholeAdjusted4Rep.Rdata")
load("~/Documents/Research/TnqData/FinalData/logRatioKnockoffParamdclpbWholeAdjusted4Rep.Rdata")
...
save(file='/Users/tingtingzhao/Documents/Research/TnqData/FinalData/wildhigh_long.Rata',wildhigh_long)
save(file='/Users/tingtingzhao/Documents/Research/TnqData/FinalData/wildSelect.Rata', wildSelect)
wild.avg = wildhigh_long%>%group_by(strain,Pert,condition,slevel,time,name)%>%summarise(mean_value=mean(value))


#-----
load(file='/Users/tingtingzhao/Documents/Research/TnqData/FinalData/wildhigh_long.Rata')
condition_names <- c(
...
ggsave(file="~/Documents/Research/TnqData/FinalData/wild2.pdf", width=10, height=6)
#----
write.csv(selectDF, file="~/Documents/Research/TnqData/FinalData/dataFDR0.1LogRatioWholeAdjusted.csv")
## write table of countNames to csv
write.csv(wildSelect$selectInd, file="~/Documents/Research/TnqData/FinalData/dataFDR0.1DFUFreqWholeAdjusted.csv")
############################################################################################
...
write.csv(wildLotus, file="~/Documents/Research/TnqData/FinalData/wildLotus01WholeAdjusted.csv")
...
wildLotus = lotus[which(lotus$locus_tag  %in% wildSelect$selectGenes), ]
write.csv(wildLotus, file="~/Documents/Research/TnqData/FinalData/wildLotus01WholeAdjusted4Rep.csv")
write.csv(t(summary(glmnet.fit)$coefficients), file="~/Documents/Research/TnqData/FinalData/wildcoefficient01WholeAdjusted4Rep.csv")
################################################################################
...
write.csv(dlonLotus, file="~/Documents/Research/TnqData/FinalData/dlonLotus01WholeAdjusted4Rep.csv") # FDR=0.1
# write.csv(t(summary(dlonFit)$coefficients), file="~/Documents/TnqData/newdata/dyloncoefficient01.csv")
write.csv(t(summary(dlonFit)$coefficients), file="~/Documents/Research/TnqData/FinalData/dyloncoefficient01WholeAdjusted4Rep.csv")
...
save(file='/Users/tingtingzhao/Documents/Research/TnqData/FinalData/dlonhigh_long.Rata',dlonhigh_long)
save(file='/Users/tingtingzhao/Documents/Research/TnqData/FinalData/dlonSelect.Rata', dlonSelect)
#-----
load(file='/Users/tingtingzhao/Documents/Research/TnqData/FinalData/dlonhigh_long.Rata')
...
write.csv(dlonDF, file="~/Documents/Research/TnqData/FinalData/dataFDR0.1LogRatioWDLONholeAdjusted4Rep.csv")
## write table of countNames to csv
# write.csv(dlonSelect$selectInd, file="~/Documents/TnqData/newdata/dataFDR0.1DFUFreqDLONWholeAdjusted.csv")
write.csv(dlonSelect$selectInd, file="~/Documents/Research/TnqData/FinalData/dataFDR0.1DFUFreqDLONWholeAdjusted4Rep.csv")
...
write.csv(dclpaLotus, file="~/Documents/Research/TnqData/FinalData/dclpaLotus01WholeAdjusted4Rep.csv") 
...
write.csv(t(summary(dclpaFit)$coefficients), file="~/Documents/Research/TnqData/FinalData/dclpacoefficient01WholeAdjusted4Rep.csv")
...
save(file='/Users/tingtingzhao/Documents/Research/TnqData/FinalData/dclpahigh_long.Rata',dclpahigh_long)
save(file='/Users/tingtingzhao/Documents/Research/TnqData/FinalData/dclpaSelect.Rata', dclpaSelect)
#-----
load(file='/Users/tingtingzhao/Documents/Research/TnqData/FinalData/dclpahigh_long.Rata')
...
#panel.margin=unit(0,"pt"))
#------
ggsave(file="~/Documents/Research/TnqData/newdata/code/Final/dclpa2.pdf", width=10, height=6)
#----
# Run clustering
...
################################################################################
write.csv(dclpaDF, file="~/Documents/Research/TnqData/FinalData/dataFDR0.1LogRatiodclpaWholeAdjusted.csv")
## write table of countNames to csv
write.csv(dclpaSelect$selectInd, file="~/Documents/Research/TnqData/FinalData/dataFDR0.1DFUFreqdclpaWholeAdjusted.csv")
...
write.csv(dnakLotus, file="~/Documents/Research/TnqData/FinalData/dnakLotus01WholeAdjusted4Rep.csv")
# write.csv(t(summary(dclpaFit)$coefficients), file="~/Documents/TnqData/newdata/dclpacoefficient.csv") #FDR=0.2
# write.csv(t(summary(dnakFit)$coefficients), file="~/Documents/TnqData/newdata/dnakcoefficient01WholeAdjusted.csv")
write.csv(t(summary(dnakFit)$coefficients), file="~/Documents/Research/TnqData/FinalData/dnakcoefficient01WholeAdjusted4Rep.csv")#FDR=0.1
...
save(file='/Users/tingtingzhao/Documents/Research/TnqData/FinalData/dnakhigh_long.Rata',dnakhigh_long)
save(file='/Users/tingtingzhao/Documents/Research/TnqData/FinalData/dnakSelect.Rata', dnakSelect)
#-----
load(file='/Users/tingtingzhao/Documents/Research/TnqData/FinalData/dnakhigh_long.Rata')
#----
# Run clustering
...
print(dendro.plot, vp = viewport(x = 0.90, y = 0.47, width = 0.2, height = 0.95))
#-------
write.csv(dnakDF, file="~/Documents/Research/TnqData/FinalData/dataFDR0.1LogRatiodnakWholeAdjusted.csv")
## write table of countNames to csv
write.csv(dnakSelect$selectInd, file="~/Documents/Research/TnqData/FinalData/dataFDR0.1DFUFreqdnakWholeAdjusted.csv")
...
write.csv(dclpbLotus, file="~/Documents/Research/TnqData/FinalData/dclpbLotus01WholeAdjusted4Rep.csv") 
# write.csv(t(summary(dclpaFit)$coefficients), file="~/Documents/TnqData/newdata/dclpacoefficient.csv") #FDR=0.2
# write.csv(t(summary(dclpbFit)$coefficients), file="~/Documents/TnqData/newdata/dclpbcoefficient01WholeAdjusted.csv") #FDR=0.1
write.csv(t(summary(dclpbFit)$coefficients), file="~/Documents/Research/TnqData/FinalData/dclpbcoefficient01WholeAdjusted4Rep.csv") #FDR=0.1
...
save(file='/Users/tingtingzhao/Documents/Research/TnqData/FinalData/dclpbhigh_long.Rata',dclpbhigh_long)
save(file='/Users/tingtingzhao/Documents/Research/TnqData/FinalData/dclpbSelect.Rata', dclpbSelect)
#-----
load(file='/Users/tingtingzhao/Documents/Research/TnqData/FinalData/dclpbhigh_long.Rata')
#------
# Run clustering
...
print(dendro.plot, vp = viewport(x = 0.90, y = 0.47, width = 0.2, height = 0.95))
################################################################################################
dclpbDF = cbind(dfu[, 1:5], dfu[,names(dclpbSelect$selectInd)])
dclpbHigh = dclpbDF %>% filter(strain=="DCLPB" && slevel=="HIGH")
dclpbGeneMat = dclpbHigh[, 6:dim(dclpbHigh)[2]]
cluster = dclpbHigh$condition
write.csv(dclpbDF, file="~/Documents/Research/TnqData/FinalData/dataFDR0.1LogRatiodclpbWholeAdjusted.csv")
## write table of countNames to csv
write.csv(dclpbSelect$selectInd, file="~/Documents/Research/TnqData/FinalData/dataFDR0.1DFUFreqdclpbWholeAdjusted.csv")
...
save(routes_tidy,file="~/Documents/Research/TnqData/FinalData/routes_tidy_adjusted4Rep.Rdata")
save(dfTotal, file="~/Documents/Research/TnqData/FinalData/routes_tidy_df_adjusted4Rep.Rdata")
